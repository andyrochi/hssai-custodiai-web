...
<template>
  <BasicLayout>
    <h1 class="text-2xl font-bold">模式一：選項輸入</h1>
    ...
    <div class="md:columns-2 mt-6">
      <div class="mb-6 border-b md:mb-0 md:border-r md:border-b-0">
        <div>
          <h2 class="text-xl">
            對父親<span class="text-green-800 font-bold">有利</span>的因素選項
          </h2>
          <div class="px-2 py-2">
            <CustodyMultiSelect
        ...
        <div>
          <h2 class="text-xl">對父親<span class="text-red-800 font-bold">不利</span>的因素選項</h2>
          <div class="px-2 py-2">
            <CustodyMultiSelect
      ...
      <div>
        <div>
          <h2 class="text-xl">
            對母親<span class="text-green-800 font-bold">有利</span>的因素選項
          </h2>
          <div class="px-2 py-2">
            <CustodyMultiSelect
        ...
        <div>
          <h2 class="text-xl">對母親<span class="text-red-800 font-bold">不利</span>的因素選項</h2>
          <div class="px-2 py-2">
            <CustodyMultiSelect
